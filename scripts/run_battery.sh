#!/bin/bash
# ==============================================================================
# Robustness Battery for STTI2026 rev084 §3.4bis
# ==============================================================================
...
#   - tamarin-prover 1.10.0 or 1.12.0 on PATH (recommend 1.12.0 to match rev082 baseline)
#   - maude 3.4+ on PATH
...
#
# Reproduces the exact command line used for rev082 timeout-curve measurements:
